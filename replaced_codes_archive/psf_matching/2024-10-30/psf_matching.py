...
def smooth_slice(cube, cube_unc, waves, i, pixsize_arcsec, wave_out, jwst_inst_in, jwst_inst_out, n_reals, advanced_noise, regul, method, enable_printout, psf_out=None):
    '''
...
def smooth_slice_cube(cube, cube_unc, waves, pixsize_arcsec, wave_out, jwst_inst_in, jwst_inst_out, n_reals=100, advanced_noise=False, regul=0.1, method='A+11', enable_printout=False):
    '''
