...
image_data_69_temp, wavelengths69, overlap69_temp = bnf.flux_aligner3(wavelengths1b, wavelengths77, image_data_1b_noline[:,50,50], image_data_77[:,50,50])
...
image_data_1b_noline_regrid2 = np.zeros((len(image_data_1b_noline[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))
...
for i in range(array_length_regrid2_x):
    ...
    for j in range(array_length_regrid2_y):
        ...
        image_data_1b_noline_regrid2[:,i,j] = np.mean(image_data_1b_noline[:,3*i:3*(i+1), 3*j:3*(j+1)], axis=(1,2))
...
image_data_1b_cont_regrid2 = np.zeros((len(image_data_1b_noline_regrid2[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))

points62_regrid2_wide_1 = [5.81, 5.94, 6.59, 6.61] #was originally [5.68, 5.945, 6.53, 6.61], then [5.945, 6.56, 6.61, 6.79]

for i in range(array_length_regrid2_x):
    for j in range(array_length_regrid2_y):
        image_data_1b_cont_regrid2[:,i,j] = bnf.linear_continuum_single_channel(
            wavelengths1b, image_data_1b_noline_regrid2[:,i,j], points62_regrid2_wide_1)
...
ax.invert_yaxis()
plt.savefig('PDFtime/profile_comparisons/062_3x3_intensity.png', bbox_inches='tight')
plt.show()
#plt.close()
...
plt.plot(wavelengths1b, image_data_1b_noline_regrid2[:,10,16], color='black', label='south')
plt.plot(wavelengths1b, image_data_1b_cont_regrid2[:,10,16])
plt.xlim(5.7, 6.6)
#plt.ylim(5000, 15000)
plt.savefig('PDFtime/profile_comparisons/062_south_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('east, 14, 12')
plt.plot(wavelengths1b, image_data_1b_noline_regrid2[:,14,12], color='blue', label='east, scale=')
plt.plot(wavelengths1b, image_data_1b_cont_regrid2[:,14,12])
plt.xlim(5.7, 6.6)
#plt.ylim(5000, 25000)
plt.savefig('PDFtime/profile_comparisons/062_east_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('north, 26, 17')
plt.plot(wavelengths1b, image_data_1b_noline_regrid2[:,26,17], color='purple', label='north, scale=')
plt.plot(wavelengths1b, image_data_1b_cont_regrid2[:,26,17])
plt.xlim(5.7, 6.6)
#plt.ylim(3000, 13000)
plt.savefig('PDFtime/profile_comparisons/062_north_cont.png', bbox_inches='tight')
plt.show()

#%%

data_scale = (image_data_1b_noline_regrid2[:,10,16] - image_data_1b_cont_regrid2[:,10,16])[np.where(np.round(wavelengths1b, 2) == 6.22)[0][0]]
comparison_scale_1 = (image_data_1b_noline_regrid2[:,14,12] - image_data_1b_cont_regrid2[:,14,12])[np.where(np.round(wavelengths1b, 2) == 6.22)[0][0]]
comparison_scale_2 = (image_data_1b_noline_regrid2[:,26,17] - image_data_1b_cont_regrid2[:,26,17])[np.where(np.round(wavelengths1b, 2) == 6.22)[0][0]]
scaling1 = data_scale/comparison_scale_1
scaling2 = data_scale/comparison_scale_2

plt.figure()
plt.title('6.2 profiles, 3x3')
plt.plot(wavelengths1b, (image_data_1b_noline_regrid2[:,10,16] - image_data_1b_cont_regrid2[:,10,16]), color='black', label='south')
plt.plot(wavelengths1b, scaling1*(image_data_1b_noline_regrid2[:,14,12] - image_data_1b_cont_regrid2[:,14,12]), color='blue', label='east, scale=' + str(scaling1), alpha=0.5)
plt.plot(wavelengths1b, scaling2*(image_data_1b_noline_regrid2[:,26,17] - image_data_1b_cont_regrid2[:,26,17]), color='red', label='north, scale=' + str(scaling2), alpha=0.5)
plt.xlim(5.7, 6.6)
#plt.ylim(0, 1500)
plt.savefig('PDFtime/profile_comparisons/062_profile_comparisons.png', bbox_inches='tight')
plt.show()

#%%

#using the above to make an array of the correct size to fill
image_data_69 = np.zeros((len(image_data_69_temp), array_length_x, array_length_y))

for i in range(array_length_x):
    for j in range(array_length_y):
        image_data_69[:,i,j], wavelengths69, overlap69 = bnf.flux_aligner3(wavelengths1b, wavelengths77, image_data_1b_noline[:,i,j], image_data_77[:,i,j])



#regridding 6-9 intensity , 3x3

array_length_regrid2_x = int((array_length_x)/3)
array_length_regrid2_y = int((array_length_y-1)/3)

pah_intensity_regrid2_69 = np.zeros((array_length_regrid2_x, array_length_regrid2_y))
image_data_69_regrid2 = np.zeros((len(image_data_69[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))


for i in range(array_length_regrid2_x):
    print(3*i, 3*(i+1))
    for j in range(array_length_regrid2_y):
        pah_intensity_regrid2_69[i,j] = np.mean(pah_intensity_77[3*i:3*(i+1), 3*j:3*(j+1)])
        image_data_69_regrid2[:,i,j] = np.mean(image_data_69[:,3*i:3*(i+1), 3*j:3*(j+1)], axis=(1,2))
...
#%%
ax = plt.figure(figsize=(8,8)).add_subplot(111)
plt.title('6-9 3x3', fontsize=16)
plt.imshow(pah_intensity_regrid2_69)
plt.colorbar()
#data border
#plt.plot([10, 95, 109, 24, 10], [80, 97, 25, 8, 80], color='black')
#plt.plot([49, 86, 61, 73, 69, 54, 60.5, 49], [88, 95, 54, 42, 17, 14, 54, 88], color='green')
...
ax.invert_yaxis()
plt.savefig('PDFtime/profile_comparisons/060_090_3x3_intensity.png', bbox_inches='tight')
plt.show()
#plt.close()
...
plt.figure()
plt.title('south, 10, 16')
plt.plot(wavelengths69, image_data_69_regrid2[:,10,16], color='black', label='south')
#plt.plot(wavelengths69, image_data_1b_cont_regrid2[:,10,16])
plt.xlim(6.0, 9.0)
#plt.ylim(5000, 15000)
plt.savefig('PDFtime/profile_comparisons/060_090_south_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('east, 14, 12')
plt.plot(wavelengths69, image_data_69_regrid2[:,14,12], color='blue', label='east, scale=')
#plt.plot(wavelengths69, image_data_1b_cont_regrid2[:,14,12])
plt.xlim(6.0, 9.0)
#plt.ylim(5000, 25000)
plt.savefig('PDFtime/profile_comparisons/060_090_east_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('north, 26, 17')
plt.plot(wavelengths69, image_data_69_regrid2[:,26,17], color='purple', label='north, scale=')
#plt.plot(wavelengths69, image_data_1b_cont_regrid2[:,26,17])
plt.xlim(6.0, 9.0)
#plt.ylim(3000, 13000)
plt.savefig('PDFtime/profile_comparisons/060_090_north_cont.png', bbox_inches='tight')
plt.show()

#%%

data_scale = (image_data_69_regrid2[:,10,16])[np.where(np.round(wavelengths69, 2) == 6.22)[0][0]]
comparison_scale_1 = (image_data_69_regrid2[:,14,12])[np.where(np.round(wavelengths69, 2) == 6.22)[0][0]]
comparison_scale_2 = (image_data_69_regrid2[:,26,17])[np.where(np.round(wavelengths69, 2) == 6.22)[0][0]]
scaling1 = data_scale/comparison_scale_1
scaling2 = data_scale/comparison_scale_2

plt.figure()
plt.title('6-9 profiles, 3x3')
plt.plot(wavelengths69, (image_data_69_regrid2[:,10,16]), color='black', label='south')
plt.plot(wavelengths69, scaling1*(image_data_69_regrid2[:,14,12]), color='blue', label='east, scale=' + str(scaling1), alpha=0.5)
plt.plot(wavelengths69, scaling2*(image_data_69_regrid2[:,26,17]), color='red', label='north, scale=' + str(scaling2), alpha=0.5)
plt.xlim(6.0, 9.0)
plt.ylim(1000, 6000)
plt.savefig('PDFtime/profile_comparisons/060_090_profile_comparisons.png', bbox_inches='tight')
plt.show()
...
#regridding 11.2 intensity , 3x3

array_length_regrid2_x = int((array_length_x)/3)
array_length_regrid2_y = int((array_length_y-1)/3)

pah_intensity_regrid2_112 = np.zeros((array_length_regrid2_x, array_length_regrid2_y))
image_data_112_regrid2 = np.zeros((len(image_data_112[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))


for i in range(array_length_regrid2_x):
    print(3*i, 3*(i+1))
    for j in range(array_length_regrid2_y):
        pah_intensity_regrid2_112[i,j] = np.mean(pah_intensity_112[3*i:3*(i+1), 3*j:3*(j+1)])
        image_data_112_regrid2[:,i,j] = np.mean(image_data_112[:,3*i:3*(i+1), 3*j:3*(j+1)], axis=(1,2))
...
#continuum
image_data_112_cont_1 = np.zeros((len(image_data_112[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))
...
for i in range(array_length_regrid2_x):
    for j in range(array_length_regrid2_y):
        image_data_112_cont_1[:,i,j] = bnf.linear_continuum_single_channel(
            wavelengths112, image_data_112_regrid2[:,i,j], points112_1) #note image_data_112 is built out of things with no lines
        


image_data_112_cont_2 = np.zeros((len(image_data_112[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))
...
for i in range(array_length_regrid2_x):
    for j in range(array_length_regrid2_y):
        image_data_112_cont_2[:,i,j] = bnf.linear_continuum_single_channel(
            wavelengths112, image_data_112_regrid2[:,i,j], points112_2) #note image_data_112 is built out of things with no lines
        


#%%
image_data_112_cont_regrid2 = np.copy(image_data_112_cont_1)

#make an array to keep track of which 11.2 continuum is being used
cont_type_112_regrid2 = np.ones((array_length_x, array_length_y))
...
for i in range(array_length_regrid2_x):
    for j in range(array_length_regrid2_y):
        if image_data_112_cont_regrid2[temp_index_2,i,j] - image_data_112_cont_regrid2[temp_index_1,i,j] < -25:
            cont_type_112_regrid2[i,j] += 1
            image_data_112_cont_regrid2[:,i,j] = image_data_112_cont_2[:,i,j]  

#%%


ax = plt.figure(figsize=(8,8)).add_subplot(111)
plt.title('11.2 3x3', fontsize=16)
plt.imshow(pah_intensity_regrid2_112)
plt.colorbar()
#data border
#plt.plot([10, 95, 109, 24, 10], [80, 97, 25, 8, 80], color='black')
#plt.plot([49, 86, 61, 73, 69, 54, 60.5, 49], [88, 95, 54, 42, 17, 14, 54, 88], color='green')
...
ax.invert_yaxis()
plt.savefig('PDFtime/profile_comparisons/112_3x3_intensity.png', bbox_inches='tight')
plt.show()
#plt.close()
...
plt.figure()
plt.title('south, 10, 16')
plt.plot(wavelengths112, image_data_112_regrid2[:,10,16], color='black', label='south')
plt.plot(wavelengths112, image_data_112_cont_regrid2[:,10,16])
plt.xlim(10.5, 11.8)
#plt.ylim(5000, 15000)
plt.savefig('PDFtime/profile_comparisons/112_south_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('east, 14, 12')
plt.plot(wavelengths112, image_data_112_regrid2[:,14,12], color='blue', label='east, scale=')
plt.plot(wavelengths112, image_data_112_cont_regrid2[:,14,12])
plt.xlim(10.5, 11.8)
#plt.ylim(5000, 25000)
plt.savefig('PDFtime/profile_comparisons/112_east_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('north, 26, 17')
plt.plot(wavelengths112, image_data_112_regrid2[:,26,17], color='purple', label='north, scale=')
plt.plot(wavelengths112, image_data_112_cont_regrid2[:,26,17])
plt.xlim(10.5, 11.8)
#plt.ylim(3000, 13000)
plt.savefig('PDFtime/profile_comparisons/112_north_cont.png', bbox_inches='tight')
plt.show()

#%%

data_scale = (image_data_112_regrid2[:,10,16] - image_data_112_cont_regrid2[:,10,16])[np.where(np.round(wavelengths112, 2) == 11.25)[0][0]]
comparison_scale_1 = (image_data_112_regrid2[:,14,12] - image_data_112_cont_regrid2[:,14,12])[np.where(np.round(wavelengths112, 2) == 11.25)[0][0]]
comparison_scale_2 = (image_data_112_regrid2[:,26,17] - image_data_112_cont_regrid2[:,26,17])[np.where(np.round(wavelengths112, 2) == 11.25)[0][0]]
scaling1 = data_scale/comparison_scale_1
scaling2 = data_scale/comparison_scale_2

plt.figure()
plt.title('11.2 profiles, 3x3')
plt.plot(wavelengths112, (image_data_112_regrid2[:,10,16] - image_data_112_cont_regrid2[:,10,16]), color='black', label='south')
plt.plot(wavelengths112, scaling1*(image_data_112_regrid2[:,14,12] - image_data_112_cont_regrid2[:,14,12]), color='blue', label='east, scale=' + str(scaling1), alpha=0.5)
plt.plot(wavelengths112, scaling2*(image_data_112_regrid2[:,26,17] - image_data_112_cont_regrid2[:,26,17]), color='red', label='north, scale=' + str(scaling2), alpha=0.5)
plt.xlim(10.5, 11.8)
#plt.ylim(0, 1500)
plt.savefig('PDFtime/profile_comparisons/112_profile_comparisons.png', bbox_inches='tight')
plt.show()
...
#regridding 12.0 intensity , 3x3

array_length_regrid2_x = int((array_length_x)/3)
array_length_regrid2_y = int((array_length_y-1)/3)

pah_intensity_regrid2_120 = np.zeros((array_length_regrid2_x, array_length_regrid2_y))
image_data_3a_noline_regrid2 = np.zeros((len(image_data_3a_noline[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))


for i in range(array_length_regrid2_x):
    print(3*i, 3*(i+1))
    for j in range(array_length_regrid2_y):
        pah_intensity_regrid2_120[i,j] = np.mean(pah_intensity_120[3*i:3*(i+1), 3*j:3*(j+1)])
        image_data_3a_noline_regrid2[:,i,j] = np.mean(image_data_3a_noline[:,3*i:3*(i+1), 3*j:3*(j+1)], axis=(1,2))

#continuum

image_data_3a_cont_regrid2 = np.zeros((len(image_data_3a_noline[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))

points120 = [11.65, 11.79, 12.25, 13.08]

for i in range(array_length_regrid2_x):
    for j in range(array_length_regrid2_y):
        image_data_3a_cont_regrid2[:,i,j] = bnf.linear_continuum_single_channel(
            wavelengths3a, image_data_3a_noline_regrid2[:,i,j], points120)
        
        
#%%
ax = plt.figure(figsize=(8,8)).add_subplot(111)
plt.title('12.0 3x3', fontsize=16)
plt.imshow(pah_intensity_regrid2_62)
plt.colorbar()
#data border
#plt.plot([10, 95, 109, 24, 10], [80, 97, 25, 8, 80], color='black')
...
ax.invert_yaxis()
plt.savefig('PDFtime/profile_comparisons/120_3x3_intensity.png', bbox_inches='tight')
plt.show()
#plt.close()
...
plt.figure()
plt.title('south, 10, 16')
plt.plot(wavelengths3a, image_data_3a_noline_regrid2[:,10,16], color='black', label='south')
plt.plot(wavelengths3a, image_data_3a_cont_regrid2[:,10,16])
plt.xlim(11.6, 12.6)
#plt.ylim(5000, 15000)
plt.savefig('PDFtime/profile_comparisons/120_south_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('east, 14, 12')
plt.plot(wavelengths3a, image_data_3a_noline_regrid2[:,14,12], color='blue', label='east, scale=')
plt.plot(wavelengths3a, image_data_3a_cont_regrid2[:,14,12])
plt.xlim(11.6, 12.6)
#plt.ylim(5000, 25000)
plt.savefig('PDFtime/profile_comparisons/120_east_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('north, 26, 17')
plt.plot(wavelengths3a, image_data_3a_noline_regrid2[:,26,17], color='purple', label='north, scale=')
plt.plot(wavelengths3a, image_data_3a_cont_regrid2[:,26,17])
plt.xlim(11.6, 12.6)
#plt.ylim(3000, 13000)
plt.savefig('PDFtime/profile_comparisons/120_north_cont.png', bbox_inches='tight')
plt.show()

#%%

data_scale = (image_data_3a_noline_regrid2[:,10,16] - image_data_3a_cont_regrid2[:,10,16])[np.where(np.round(wavelengths3a, 2) == 12.0)[0][0]]
comparison_scale_1 = (image_data_3a_noline_regrid2[:,14,12] - image_data_3a_cont_regrid2[:,14,12])[np.where(np.round(wavelengths3a, 2) == 12.0)[0][0]]
comparison_scale_2 = (image_data_3a_noline_regrid2[:,26,17] - image_data_3a_cont_regrid2[:,26,17])[np.where(np.round(wavelengths3a, 2) == 12.0)[0][0]]
scaling1 = data_scale/comparison_scale_1
scaling2 = data_scale/comparison_scale_2

plt.figure()
plt.title('12.0 profiles, 3x3')
plt.plot(wavelengths3a, (image_data_3a_noline_regrid2[:,10,16] - image_data_3a_cont_regrid2[:,10,16]), color='black', label='south')
plt.plot(wavelengths3a, scaling1*(image_data_3a_noline_regrid2[:,14,12] - image_data_3a_cont_regrid2[:,14,12]), color='blue', label='east, scale=' + str(scaling1), alpha=0.5)
plt.plot(wavelengths3a, scaling2*(image_data_3a_noline_regrid2[:,26,17] - image_data_3a_cont_regrid2[:,26,17]), color='red', label='north, scale=' + str(scaling2), alpha=0.5)
plt.xlim(11.6, 12.6)
plt.ylim(-50, 1000)
plt.savefig('PDFtime/profile_comparisons/120_profile_comparisons.png', bbox_inches='tight')
plt.show()
...
#regridding 13.5 intensity , 3x3

array_length_regrid2_x = int((array_length_x)/3)
array_length_regrid2_y = int((array_length_y-1)/3)

pah_intensity_regrid2_135 = np.zeros((array_length_regrid2_x, array_length_regrid2_y))
image_data_135_regrid2 = np.zeros((len(image_data_135[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))


for i in range(array_length_regrid2_x):
    print(3*i, 3*(i+1))
    for j in range(array_length_regrid2_y):
        pah_intensity_regrid2_135[i,j] = np.mean(pah_intensity_135[3*i:3*(i+1), 3*j:3*(j+1)])
        image_data_135_regrid2[:,i,j] = np.mean(image_data_135[:,3*i:3*(i+1), 3*j:3*(j+1)], axis=(1,2))

#continuum

image_data_135_cont_regrid2 = np.zeros((len(image_data_135_regrid2[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))

points135 = [13.21, 13.31, 13.83, 14.00] #last one is a filler value at the moment

for i in range(array_length_regrid2_x):
    for j in range(array_length_regrid2_y):
        image_data_135_cont_regrid2[:,i,j] = bnf.linear_continuum_single_channel(
            wavelengths135, image_data_135_regrid2[:,i,j], points135) #note image_data_135 is built out of things with no lines
...
ax = plt.figure(figsize=(8,8)).add_subplot(111)
plt.title('13.5 3x3', fontsize=16)
plt.imshow(pah_intensity_regrid2_135)
plt.colorbar()
#data border
#plt.plot([10, 95, 109, 24, 10], [80, 97, 25, 8, 80], color='black')
#plt.plot([49, 86, 61, 73, 69, 54, 60.5, 49], [88, 95, 54, 42, 17, 14, 54, 88], color='green')
...
ax.invert_yaxis()
plt.savefig('PDFtime/profile_comparisons/135_3x3_intensity.png', bbox_inches='tight')
plt.show()
#plt.close()
...
plt.figure()
plt.title('south, 10, 16')
plt.plot(wavelengths135, image_data_135_regrid2[:,10,16], color='black', label='south')
plt.plot(wavelengths135, image_data_135_cont_regrid2[:,10,16])
plt.xlim(13.0, 14.5)
#plt.ylim(5000, 15000)
plt.savefig('PDFtime/profile_comparisons/135_south_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('east, 14, 12')
plt.plot(wavelengths135, image_data_135_regrid2[:,14,12], color='blue', label='east, scale=')
plt.plot(wavelengths135, image_data_135_cont_regrid2[:,14,12])
plt.xlim(13.0, 14.5)
#plt.ylim(5000, 25000)
plt.savefig('PDFtime/profile_comparisons/135_east_cont.png', bbox_inches='tight')
plt.show()

plt.figure()
plt.title('north, 26, 17')
plt.plot(wavelengths135, image_data_135_regrid2[:,26,17], color='purple', label='north, scale=')
plt.plot(wavelengths135, image_data_135_cont_regrid2[:,26,17])
plt.xlim(13.0, 14.5)
#plt.ylim(3000, 13000)
plt.savefig('PDFtime/profile_comparisons/135_north_cont.png', bbox_inches='tight')
plt.show()

#%%

data_scale = (image_data_135_regrid2[:,10,16] - image_data_135_cont_regrid2[:,10,16])[np.where(np.round(wavelengths135, 2) == 13.57)[0][0]]
comparison_scale_1 = (image_data_135_regrid2[:,14,12] - image_data_135_cont_regrid2[:,14,12])[np.where(np.round(wavelengths135, 2) == 13.57)[0][0]]
comparison_scale_2 = (image_data_135_regrid2[:,26,17] - image_data_135_cont_regrid2[:,26,17])[np.where(np.round(wavelengths135, 2) == 13.57)[0][0]]
scaling1 = data_scale/comparison_scale_1
scaling2 = data_scale/comparison_scale_2

plt.figure()
plt.title('13.5 profiles, 3x3')
plt.plot(wavelengths135, (image_data_135_regrid2[:,10,16] - image_data_135_cont_regrid2[:,10,16]), color='black', label='south')
plt.plot(wavelengths135, scaling1*(image_data_135_regrid2[:,14,12] - image_data_135_cont_regrid2[:,14,12]), color='blue', label='east, scale=' + str(scaling1), alpha=0.5)
plt.plot(wavelengths135, scaling2*(image_data_135_regrid2[:,26,17] - image_data_135_cont_regrid2[:,26,17]), color='red', label='north, scale=' + str(scaling2), alpha=0.5)
plt.xlim(13.0, 14.0)
plt.ylim(-100, 800)
plt.savefig('PDFtime/profile_comparisons/135_profile_comparisons.png', bbox_inches='tight')
plt.show()
...
image_data_164_noline_regrid2 = np.zeros((len(image_data_3c_noline[:,0,0]), array_length_regrid2_x, array_length_regrid2_y))
...
for i in range(array_length_regrid2_x):
    ...
    for j in range(array_length_regrid2_y):
        ...
        image_data_164_noline_regrid2[:,i,j] = np.mean(image_data_3c_noline[:,3*i:3*(i+1), 3*j:3*(j+1)], axis=(1,2))
...
wavelengths164_wide = np.copy(wavelengths3c)
image_data_164_noline_regrid2_wide = np.copy(image_data_164_noline_regrid2)
...
ax.invert_yaxis()
plt.savefig('PDFtime/profile_comparisons/164_3x3_intensity.png', bbox_inches='tight')
plt.show()
#plt.close()
...
plt.plot(wavelengths164_wide, scaling2*(image_data_164_noline_regrid2_wide[:,26,17] - image_data_164_cont_regrid2_wide[:,26,17]), color='red', label='north, scale=' + str(scaling2), alpha=0.5)
plt.xlim(16.0, 17.0)
plt.ylim(0, 1500)
plt.savefig('PDFtime/profile_comparisons/164_profile_comparisons.png', bbox_inches='tight')
plt.show()
